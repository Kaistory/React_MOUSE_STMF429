...
PHÁT SINH
--
- Xung đột giữa USB_HID và hàm lấy vị trí trên màn hình TouchGFX(evt.getX() ỏ evt.getY())
- Chỉnh sửa : giảm tần số màn hình LCD 1/2 (12,5hz)(chú ý thay đổi vị trí với màn hình)
